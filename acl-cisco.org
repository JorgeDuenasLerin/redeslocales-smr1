...
** Planteamiento
   ...
   |   | /V/ | /TCP si es una conexión entrante de la DMZ/ | /X/ | TCP si es una conexión entranta de la DMZ |
   |   | /X/ | UDP                                         | /X/ | UDP                                       |
   |---+-----+---------------------------------------------+-----+-------------------------------------------|
   #+REVEAL: split
   ...
   |   | /V/ | /TCP si se ha establecido desde la LAN/   | /V/ | /TCP si se ha establecido desde la LAN/   |
   |   | /X/ | TCP si es una conexión entranta de la DMZ | /X/ | TCP si es una conexión entrante de la DMZ |
   |   | /X/ | UDP                                       | /X/ | UDP                                       |
   |---+-----+-------------------------------------------+-----+-------------------------------------------|
